...
module.exports = {
    name: "3dneon",
    alias: ["3dn"],
    desc: "Make 3D Neon Logo with random style",
    category: "Logo Maker",
    react: "🍁",

    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}3dneon Marin-MD Bot*`)
        ...
        try {
            ...
            const queries = ["neon", "cyberpunk", "city", "abstract", "technology"]
