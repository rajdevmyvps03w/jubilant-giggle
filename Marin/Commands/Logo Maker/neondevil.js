...
const neonColors = ["#ff0000", "#ff33ff", "#ff9900", "#ff3399", "#00ffff", "#00ff00", "#ffff00"]

module.exports = {
    name: "neondevil",
    alias: ["ndevil", "nd", "neond"],
    desc: "Make Neon Devil Style 3D Text Logo with random background",
    category: "Logo Maker",
    react: "🍁",

    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}neondevil Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM "DEVIL" IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const query = "devil,neon,dark,city"
            ...
            console.error(err)
            m.reply("Error while generating neon devil logo.")
        }
    }
}
