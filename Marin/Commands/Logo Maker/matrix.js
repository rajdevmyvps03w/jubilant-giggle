...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}matrix Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM MATRIX / TECH IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["matrix code", "technology", "digital", "cyber"]
            ...
            // --- Neon Glow Layers (Matrix Green) ---
            const shadowLevels = [25, 50, 80]
            const neonColor = "#00ff00" // classic matrix green
