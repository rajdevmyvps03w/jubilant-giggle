...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}deepsea Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM DEEPSEA IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["deep sea", "ocean", "underwater", "sea"]
            ...
            const colors = ["#00ffff", "#0099ff", "#0033cc", "#00ffcc", "#66ffff"]
