...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}bokeh Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM BOKEH/LIGHT IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["bokeh", "lights", "blur", "night lights", "colorful lights"]
            ...
            const neonColors = ["#ff00ff", "#00ffff", "#ffff00", "#ff9900", "#00ff00"]
