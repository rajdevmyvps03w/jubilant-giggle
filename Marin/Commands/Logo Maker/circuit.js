...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}circuit Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM CIRCUIT IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["circuit board", "technology", "digital background", "tech pattern"]
            ...
            const colors = ["#00ffff", "#ff00ff", "#00ff00", "#ffff00", "#ff9900"] // Neon tech colors
