...
module.exports = {
    name: "3dspace",
    alias: ["3ds"],
    desc: "Make 3D Space Neon Logo with random style",
    category: "Logo Maker",
    react: "🍁",

    start: async (Miku, m, { prefix, text}) => {
        if (!text) return m.reply(`Example: *${prefix}3dspace Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM SPACE IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["space", "galaxy", "stars", "nebula", "universe"]
