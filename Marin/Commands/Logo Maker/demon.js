...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}demon Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM DEMON / DARK IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["demon", "dark", "fire", "evil"]
            ...
            // --- RANDOM FONT & DEMON COLORS ---
            const font = fonts[Math.floor(Math.random() * fonts.length)]
            const colors = ["#ff0000", "#990000", "#ff3300", "#cc0000", "#ff6666"]
