...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}blackpink Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM BLACKPINK STYLE IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["pink", "neon", "glamour", "party", "fashion"]
            ...
            // --- RANDOM FONT & NEON PINK COLORS ---
            const font = fonts[Math.floor(Math.random() * fonts.length)]
            const neonColors = ["#ff69b4", "#ff1493", "#ff3399", "#ff66cc"]
