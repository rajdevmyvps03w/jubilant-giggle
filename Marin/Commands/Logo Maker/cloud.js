...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}cloud Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM CLOUD IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["clouds", "sky", "sunset sky", "blue sky"]
            ...
            const colors = ["#00ffff", "#ff99ff", "#ffffff", "#ffcc00", "#99ffcc"]
