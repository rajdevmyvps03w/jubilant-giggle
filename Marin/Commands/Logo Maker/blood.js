...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}blood Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM BLOOD STYLE IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["blood", "red", "dark", "horror", "vampire"]
            ...
            // --- RANDOM FONT & BLOOD RED COLORS ---
            const font = fonts[Math.floor(Math.random() * fonts.length)]
            const neonColors = ["#ff0000", "#cc0000", "#990000", "#ff3333"]
