...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}candy Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM CANDY/LIGHTS IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["candy", "colorful sweets", "sweet lights", "colorful background"]
            ...
            const neonColors = ["#ff69b4", "#ff1493", "#ff4500", "#ff6347", "#ff00ff", "#ffb6c1"]
