...
module.exports = {
    ...
    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}lion Marin-MD Bot*`)
        ...
        try {
            ...
            // --- PIXABAY RANDOM LION / SAFARI IMAGE ---
            const pixabayAPI = "54164246-c83b8dee398b874d43650c040"
            const queries = ["lion", "wildlife", "savannah", "jungle", "animal"]
            ...
            const neonColors = ["#ffcc00", "#ff6600", "#ff3300", "#ff0000", "#ff99cc"]
