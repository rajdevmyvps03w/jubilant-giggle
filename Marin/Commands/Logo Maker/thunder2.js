...
module.exports = {
    name: "thunder2",
    alias: ["thd2"],
    desc: "Make Thunder2 Style Text Logo",
    react: "🍁",
    category: "Logo Maker",

    start: async (Miku, m, { prefix, text }) => {
        if (!text) return m.reply(`Example: *${prefix}thunder2 Marin-MD Bot*`)
        ...
        try {
            ...
            // --- RANDOM FONT & THUNDER NEON COLORS ---
            ...
            console.error(err)
            m.reply("Error while generating Thunder2 logo.")
        }
    }
}
